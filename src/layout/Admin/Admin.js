...
export default function Admin() {
  return (
    <div className="w-full h-1/3  flex flex-wrap">
      ...
      <div className="flex flex-wrap h-full w-full items-center justify-center divide-y divide-yellow-500 p-3 md:divide-y-0 md:flex-nowrap md:divide-x md:h-96">
        ...
        <div className="flex w-full h-1/2 justify-center items-center mx-auto">
